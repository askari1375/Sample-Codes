# -*- coding: utf-8 -*-
"""
Created on Fri Sep  3 11:12:41 2021
...
def train(model,
    ...
    if kargs['loss_plot_limit'] is not None:
        ax_loss.set_ylim(0, kargs['loss_plot_limit'])
    else:
...
def evaluate_model(model, data_loder, device):
    all_loss = []
    model.eval()
    with torch.no_grad():
